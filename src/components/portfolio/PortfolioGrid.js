          ...
          <div className="bg-[#f8fafc] rounded-2xl overflow-hidden relative border border-[#e2e8f0] transition-all duration-500 hover:shadow-xl hover:shadow-[#0050cc]/5">
            ...
            <div className="absolute bottom-0 left-0 p-10 w-full">
              <div className="flex justify-between items-end">
                ...
                <div>
                  <span className="text-[#e0eaff] bg-[#0050cc]/20 backdrop-blur-sm px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest mb-3 inline-block">
                    Web Application
                  </span>
                ...
                {/* BUTTON */}
                <button className="bg-white text-[#041627] p-4 rounded-full hover:bg-[#0050cc] hover:text-white transition-all shadow-lg">
        ...
        <div className="md:col-span-4 group">
          <div className="bg-white rounded-2xl border border-[#e2e8f0] overflow-hidden h-full flex flex-col transition-all duration-500 hover:shadow-xl">
            ...
            <div className="p-8 flex flex-col flex-grow">
              <span className="text-[#0050cc] text-[10px] font-bold uppercase tracking-widest mb-2">
                Mobile Design
              </span>

              <h3 className="text-2xl font-headline font-bold text-[#0f172a] mb-4">
                Vivid Portfolio App
              </h3>

              <p className="text-[#64748b] text-sm mb-8 flex-grow">
                Interactive portfolio browser for independent artists.
              </p>

              <button className="w-full py-4 border border-[#e2e8f0] rounded-lg font-headline font-bold text-xs uppercase tracking-widest hover:bg-[#f8fafc]">
                View Project
              </button>
            </div>
          </div>
        ...
        <div className="md:col-span-8 group">
          <div className="bg-[#f8fafc] rounded-2xl overflow-hidden relative border border-[#e2e8f0] transition-all duration-500 hover:shadow-xl hover:shadow-[#0050cc]/5">
            ...
            <img
              ...
              className="w-full h-full object-cover min-h-[400px] group-hover:scale-[1.01] transition"
            />
            ...
            <div className="absolute inset-0 p-12 flex flex-col justify-center">
              ...
              <span className="text-white bg-white/10 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest mb-4 w-fit">
                Experimental Design
              </span>

              <h3 className="text-4xl font-headline font-bold text-white mb-6 leading-tight">
                Spatial <br /> Interiors VR
              </h3>

              <p className="text-slate-200 max-w-xs mb-8">
                Virtual reality walkthroughs for luxury architectural firm.
              </p>

              <button className="bg-[#0050cc] text-white px-8 py-4 rounded-lg font-bold flex items-center gap-3 hover:-translate-y-1 transition">
                Full Case Study
